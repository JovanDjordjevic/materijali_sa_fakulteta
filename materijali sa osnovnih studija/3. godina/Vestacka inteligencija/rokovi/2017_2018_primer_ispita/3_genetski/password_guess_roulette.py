...
class GeneticAlgorithm:
    ...
    def crossover(self, a, b):
        ...
        #######################################################
        # STUDENTSKI KOD
        break_point = random.randint(1, len(a))
        child1 = a[:break_point] + b[break_point:]
        child2 = b[:break_point] + a[break_point:]
    ...
    def mutation(self, chromosome):
        ...
        if mutation_chance <= self._mutation_rate:
            ...
            random_val = random.choice(self._allowed_gene_values)
            chromosome = list(chromosome)
            chromosome[random_index] = random_val
    ...
    def stop_condition(self):
        #######################################################
        # STUDENTSKI KOD
        if self._current_iteration == self._iterations or (self._target == self._top_chromosome):
            return True
        return False
        # KRAJ STUDENTSKOG KODA
        #######################################################
