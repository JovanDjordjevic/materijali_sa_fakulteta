...
final class ChatClient {
    ...
    //ovog puta su nam u klijentu potrebni threadovi
    //za to sto su operacije citanja blokirajuce (?) npr ako bi sve bilo u jednoj niti desilo bi se
    //da ne mozemo da primimo poruke dokle god ne posaljemo poruku
    //hocemo jedan thread koji cita i jedan thread koji pise
    void execute() {
        try {
            this.setName();
    ...
    private void setName() throws IOException {
        ...
        //koristicemo stdin u write threadu
    }
}