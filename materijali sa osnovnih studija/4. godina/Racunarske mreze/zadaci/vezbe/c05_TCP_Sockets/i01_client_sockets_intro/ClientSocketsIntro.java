...
final class ClientSocketsIntro {
	...
	//port je takodje broj, i raspon tog broja je 0 - 65535
	public static void main(String[] args) {
		//u konstruktoru dajemo ime hosta i broj porta na kom se konektuje (misli se na serverski port. Klijentski port nema smisla)
		try (Socket sock = new Socket("hostname", 80)) {

			// Send/Receive data...
			//od socketa mozemo dobiti streamove za komunickaciju. Obicno cemo ove streamove baferisati jer je efikasnije
			//a ta efikasnost je psoebno bitna jer radimo sa mrezom
			OutputStream out = new BufferedOutputStream(sock.getOutputStream());
			InputStream in = new BufferedInputStream(sock.getInputStream());

		} catch (UnknownHostException ex) {  //ako ne moze da se uspostavi veza sa hostom na ovom portu
