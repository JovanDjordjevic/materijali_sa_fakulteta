...
final class ClientHandlerRunnable implements Runnable {
    ...
    public void run() {
        try (
            BufferedReader in = new BufferedReader(new InputStreamReader(this.client.getInputStream(), StandardCharsets.UTF_8));
            ...
            ex.printStackTrace();
        } finally { //bitno je da stavimo zatvaranje socketa u finally blok
            try {
                this.client.close();
            } catch (IOException e) {
                e.printStackTrace();
