...
import java.io.*;                               //ovde su inuput/outpu streamovi
...
final class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //ovi do sada input i output streamovi vracaju byte array
            ...
            Reader r;
            Writer w;
            //prednost njih je sto mozemo da zadamo koji encoding je u pitanju, pa ne moramo sami da brinemo da li nam je jedan bajt neki karakter ili dva itd
            //StreamReaderi i StreamWriteri mogu da se naprave od BILO KOG streama (?). Charset je opcioni argument
            InputStreamReader sr = new InputStreamReader(fin, StandardCharsets.UTF_8);
            OutputStreamWriter sw = new OutputStreamWriter(fout, StandardCharsets.US_ASCII);
            ...
            //kada radimo sa read metodama stremova obicno moramo da hvatamo IOException

            // Stream class implements AutoCloseable interface (samo instance ove klase mogu da se stave u try with resources), therefore they can be used
            // in the following syntax (instead of manually closing the streams) (zato sto za AutoCloseable mora da se implementira close() metod)
