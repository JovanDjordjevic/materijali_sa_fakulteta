...
final class QuoteServer extends Thread {
	...
	private QuoteServer() throws IOException {
		...
		try {
			//ovo je jos jedan nacin da napravimo input stream do fajla, mogli smo i kaos to smo radili do sad
			this.in = Files.newBufferedReader(Paths.get("c08_UDP_Sockets/i04_quote/one_liners.txt"));
		} catch (NoSuchFileException e){
			//odlucili smo da napravimo logiku takvu da ako ne postoji ovaj fajl, da se klijentu vrati trenutno vreme
