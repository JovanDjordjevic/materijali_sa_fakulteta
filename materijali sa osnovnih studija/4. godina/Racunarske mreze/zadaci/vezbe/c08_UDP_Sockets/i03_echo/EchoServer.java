...
final class EchoServer extends Thread implements AutoCloseable {
	...
	//NOTE: nismo morali da pravimo nit za server. Ovo smo uradili samo zato sto smo kada smo pisali Test klasu
	// imenovali metod za pokretanje sa start(), pa kad vec imamo start ajde neka bude nit
	@Override
	public void run() {
