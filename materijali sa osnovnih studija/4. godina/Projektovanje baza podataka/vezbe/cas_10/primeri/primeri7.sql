...
Ako postoji selekcija onda se prvo ona izracunava pa se vrsi spajanje.
*/
...
-- za sledeci upit hocemo da imamo i ove i sledece indekse 
-- pa ne brisemo indekse ovde
...
--Ponavljamo upit uz postojanje indeksa nad svim atributima selekcije i spajanja.
explain analyze
select e.name, d.mgr
from Employees as e, Departments as d
where d.budget > 990000 and e.did = d.id and e.salary > 49000;
...
--Ponavljamo upit uz postojanje samo unique indeksa nad atribtima spajanja.
explain analyze
select e.name, d.mgr
from Employees as e, Departments as d
where d.budget > 990000 and e.did = d.id and e.salary > 49000;
