...
Bitan je redosled atributa zato sto je kompozitni indeks zapravo datoteka 
gde su podaci sortirani prvo po prvoma tributu, pa po drugom itd
...
--Primer kada je jedno izdvajanje intervalno, a drugo po tacnoj vrednosti.
explain analyze
select e.id
from Employees as e
where e.age = 30
...
-- Pokretanje upita sa postojanjem kompozitnog indeksa.
explain analyze
select e.id
from Employees as e
where e.age between 20 and 30
...
-- isti atributi kao u proslom samo su drugim redosledom
