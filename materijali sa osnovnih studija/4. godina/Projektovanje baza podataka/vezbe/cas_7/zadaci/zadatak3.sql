...
-- Kreira se pogled koji izdvaja sifre studenata i dane u kojima imaju los raspored
...
-- Za svakog studenta se pored broja indeksa ispisuje i  da li ima los ili dobar raspored
